-- CapCraft Release 0.2.3 password function patch
-- Run this if league creation failed with: function gen_salt(unknown) does not exist.
-- This replaces the league create/join RPC functions so they store and compare
-- an app-generated password hash instead of calling PostgreSQL crypt/gen_salt.
